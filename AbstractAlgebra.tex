...
\bibitem{Burnside}{William Snow Burnside and Arthur William Panton,``The Theory of Equations with an Introduction to the Theory of Binary Algebraic Forms, Volume 2''
 Dover Publications (1960).}
\bibitem{Spiegel}{Murray R. Spiegel,``Vector Analysis and an Introduction to Tensor Analysis''. Schaum's Outline Series, McGraw-Hill Book Company (1959).}
