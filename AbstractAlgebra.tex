...
the problem of using radicals to express the roots of polynomials. The contributions of Lagrange, Ruffini, Cauchy, Abel, Galois, Hamilton, Sylvester, and Arnold are reviewed and summarized.
\end{abstract}
\input{Logic.tex}
