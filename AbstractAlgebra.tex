...
\usepackage{makecell} % Required package
...
\begin{center}{{\twelvebf Group Theory and the Quintic : Historical Notes}}
\vglue 1.0cm
{\tenrm JOHN R.\,\,SMITH\\}
...
%\begin{abstract}
%This paper begins with an introduction to concepts in Group Theory and then moves on to applications of the Symmetric Group to 
%the problem of using radicals to express the roots of polynomials.
%The contributions of Lagrange, Ruffini, Cauchy, Abel, Galois, Wantzel, Hamilton, Sylvester, and Arnold are reviewed and summarized.
%\end{abstract}
...
%\input{Ideals.tex}
%\input{Fields.tex}
%\input{IntegralDomains.tex}
%\input{InvariantSubgroup.tex}
%\input{QuotientGroups.tex}
%%\input{NormalSubgroupRelations.tex}
%\input{QuotientRings.tex}
%%\input{VectorSpace.tex}
%%\input{Analysis.tex}
\input{FundamentalTheorem.tex}
%\input{SymmetricFunctions.tex}
%%\input{SyntheticDivision}
\input{RationalRoot.tex}
%%\input{Cauchy1815.tex}
\input{Cyclotomic.tex}
%%\input{Descartes.tex}
\input{Determinants.tex}
%\input{SpecialMatrixInverses}
%%\input{JordanCanonicalForm}
%%\input{SchurCompliment.tex}
%%\input{Reciprocal.tex}
%%\input{CauchyBinet.tex}
\input{Vandermonde.tex}
\input{RootsOfUnity.tex}
\input{AlgebraicForms}
%\input{RootsOfUnityFilters.tex}
%\input{Circulant.tex}
%\input{TwistedCirculant}
%\input{Sylvester.tex}
%\input{CirculantsAndResolvents.tex}
%\input{Abel1824.tex}
...
\input{Wantzel.tex}
\input{Abel.tex}
\input{Commutator.tex}
\input{Hamilton.tex}
\input{Arnold.tex}
%%\input{CayleyHamilton.tex}
%%\input{VectorSpaces.tex}
%%\input{FermatLittleTheorem.tex}
%%\input{ChineseRemainder.tex}
%%\input{FiniteFields.tex}
%%\input{LinearSpaces.tex}
%%\input{DotAndCrossProducts.tex}
%%\input{ReciprocalSpace.tex}
%%\input{Geometry.tex}
...
\bibitem{FMHall} {F.M. Hall,``Introduction to Abstract Algebra (Vol 2)'', Cambridge University Press (1969).}
\bibitem{Birkoff and MacLane} {Garrett Birkoff and Saunders MacLane,``A Survey of Modern Algebra'', The MacMillan Company, New York (1957).}
...
\bibitem{Burnside}{William Snow Burnside and Arthur William Panton,``The Theory of Equations with an Introduction to the Theory of Binary Algebraic Forms, Volume 2'',Dover Publications (1960).}
\bibitem{Brown}{Jim Brown, ``Abel and the Insolvability of the Quintic'', Mathematics Department The Ohio State University (2013).}
\bibitem{Pesic}{Peter Pesic, ``Abel's  Proof'', The MIT Press, Cambridge, Massachusetts (2003).}
\bibitem{Dehn}{Edgar Dehn,``Algebraic Equations : An Introduction to the Theories of Lagrange and Galois'',  Dover Publications (1960).}
\bibitem{Spiegel}{Murray R. Spiegel,``Vector Analysis and an Introduction to Tensor Analysis'', Schaum's Outline Series, McGraw-Hill Book Company (1960).}
\bibitem{Protter and Morrey}{M.H. Protter and C.B. Morrey, ``A First Course in Real Analysis'', Springer-Verlag (1977).}
\bibitem{Alekseev}{V. B. Alekseev, ``Abel's Theorem in Problems and Solutions'', Klewer Academic Publishers, (2004).}
%\bibitem{Bergmann}{Peter Gabriel Bergmann, ``Introduction to the Theory of Relativity'', Dover (1976).}
\bibitem{Cox}{David A. Cox, ``Galois Theory''', Wiley-Interscience (2004) (see page 48).}
\bibitem{Prasolov}{Victor V. Prasolov, ``Polynomials''', Springer (2001)}
