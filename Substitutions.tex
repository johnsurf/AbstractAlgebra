...
\ee whoer $T_0, T_1, \hdots, T_{\rho-1}$ are all symmetric functions of $x_1, x_2, \hdots, x_n$. 

\end{proof}


\begin{theorem}[Extension o Lagrange's Theorem to Non Symmetric Functions] If two rational functions of any set of variables are such that one remains unchanged by all the substitutions of the group to
