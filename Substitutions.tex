...
\begin{theorem}
Permutations act on products of functions homomorphically 
...
\end{theorem}
\begin{proof}
{\bf 1. Define the Permutation Action A permutation} $\sigma$ acts on a function $f$  by precomposition: \[ (\sigma \cdot f)(x) = f(\sigma^{-1}(x)) \] 
