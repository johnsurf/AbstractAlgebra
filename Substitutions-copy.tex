...
numerically with opposites signs, viz. $\sqrt{\triangle}$ and $-\sqrt{\triangle}$. $\phi(x)$ is an example
...
Linear systems such as Eq.(\ref{LagrangeSystem}) can be solved using Cramer's rule. Alternatively, in order to understand better the relatonship between $\phi$ and $\psi$ let us consider
