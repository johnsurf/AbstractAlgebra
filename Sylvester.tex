\section{Resolvent of Two Polynomials}
...
$sgn(\sigma) = \epsilon_{r_1,r_2,r_3,\hdots r_{n+m}} $ is the sign of the permutation. In the case of the Sylvester Resolvent the terms take the form 
...
Hence the Sylvester Resolvent has the form 
...
This determinant is the Sylvester Resolvent (or Sylvester Resultant), denoted as \(\text{Res}(P, R, x)\). The matrix takes the form: \\ \\
