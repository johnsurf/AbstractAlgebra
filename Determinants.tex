...
\begin{definition}
$n$-dimensional Affine Space (Vector Space) $\R_n$. An ordered $n$-tuple of real numbers, i.e., a system of $(x_1, x_2, ..., x_n)$ of $n$ real numbers in a definite order, is called a point ($n$ a positive integer). The numbers
