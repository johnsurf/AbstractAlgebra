...
\be f(x) = a_0 x^n + a_{1}x^{n-1} + ... + a_{n-1} x + a_n, \label{poly} \ee where the coefficients $ a_i  \in F, i = 1, 2, \hdots, n$ and  {\it rational} means free from fractional powers and {\it integral} means never in the denominator of a fraction. 
A polynomial function is a function which can be written in the form of Eq. (\ref{poly}). 
\end{definition}

If $a_0 = 1$ we say the polynomial is in {\it monic} form. It will often be convenient to adopt this convention; and in such cases we shall write the polynomial as 
